              ...
              <div key={id} className="flex items-center gap-4 bg-white rounded-xl shadow p-4 border border-gray-100 hover:shadow-lg transition-shadow">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <button onClick={() => updateQuantity(id, quantity - 1)} className="px-2 py-1 bg-gray-200 rounded hover:bg-gray-300 text-lg font-bold">-</button>
                    <span className="px-3 text-base">{quantity}</span>
                    <button onClick={() => updateQuantity(id, quantity + 1)} className="px-2 py-1 bg-gray-200 rounded hover:bg-gray-300 text-lg font-bold">+</button>
                    <button onClick={() => removeFromCart(id)} className="ml-4 text-red-600 hover:underline text-xs">Eliminar</button>
                  </div>
                </div>
